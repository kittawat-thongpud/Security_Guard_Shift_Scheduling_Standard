export const defaultConfigTemplate={
  ...
  shifts:[
    { name:'Morning', startTime:'06:00', size:8, requirements:{ guard:1, supervisor:1, senior:0 } },
    { name:'Afternoon', startTime:'14:00', size:8, requirements:{ guard:1, supervisor:0, senior:1 } },
    { name:'Night', startTime:'22:00', size:8, requirements:{ guard:1, supervisor:1, senior:0 } }
  ],
  employees:[
